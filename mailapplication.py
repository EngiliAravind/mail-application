...
class MailApp:
    def __init__(self, master):
        self.master = master
        master.title("Aravind Mail Application")
        tkinter.Tk.config(master, background="lightblue")

        # Create the UI
        self.from_label = tk.Label(master, text="From:       ", background="lightblue")
        ...
        self.pass_label = tk.Label(master, text="App Password:       ", background="lightblue")
        ...
        self.to_label = tk.Label(master, text="To:        ", background="lightblue")
        ...
        self.subject_label = tk.Label(master, text="Subject:     ", background="lightblue")
        ...
        self.body_label = tk.Label(master, text="Body:     ", background="lightblue")
        ...
        self.send_button = tk.Button(master, text="Send", command=self.send_mail, width=16,
                                     background="orange", foreground="White", font=8)
